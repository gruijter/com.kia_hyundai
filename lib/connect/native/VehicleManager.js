...
// token (login + refresh-before-expiry) en delegeert commando's. Logt
// mijlpalen (login, elk commando) op het niveau boven de HTTP-details die
// ApiImplSession al logt — samen de basis om niet-EU-regio's te debuggen
// via Homey's diagnostic reports (geen testaccounts beschikbaar, zie
// ../NAMING.md).
