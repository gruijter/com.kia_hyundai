...
// Poort van ApiImpl.py: de abstracte interface die elke regio-implementatie
// invult. Methodenamen zijn de camelCase-vorm van de Python snake_case-namen —
// zie ../NAMING.md. Niet-overschreven methodes gooien "not implemented",
// exact zoals upstream.
class ApiImpl {
  notImplemented(name) {
  ...
  // Wijkt bewust af van upstream: geeft de raw status-JSON van de cloud terug
  // in plaats van een Vehicle-dataclass te muteren (zie ../NAMING.md).
  // eslint-disable-next-line no-unused-vars
  ...
  // Default: gewoon opnieuw inloggen. Regio's met een echte refresh_token-flow
  // (o.a. EU) overschrijven dit.
