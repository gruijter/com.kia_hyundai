...
// Not in upstream: Python's requests raises ConnectionError/Timeout, which
// upstream lets surface as-is. Node's fetch collapses every connect/DNS
// failure into a bare "TypeError: fetch failed" with the real reason on
// error.cause — http.js#request() unwraps that into this so callers can tell
// "server/network unreachable" apart from a credential problem (see issue #25).
