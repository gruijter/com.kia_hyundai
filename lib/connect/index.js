...
// /home/robin/.claude/plans/deze-repo-is-heeft-keen-summit.md, Fase 3).
// Alleen EU is live gevalideerd (zie ../NAMING.md) — US/CA/AU/CN zijn een
// "blinde" poort van de Python-bron, nog niet tegen echte accounts getest.
const NATIVE_REGIONS = new Set(['EU', 'US', 'CA', 'AU', 'CN']);
