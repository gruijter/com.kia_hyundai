...
// Homey's platform auto-converts stock temperature capabilities (e.g.
// target_temperature) to °F for imperial-location users, but only if the
// app always writes Celsius (see homey-app-development skill, section 9) —
// so any CCS2 payload reporting its HVAC target in °F (Temperature.Unit===1)
// must be normalized here before setCapabilityValue, not passed through.
